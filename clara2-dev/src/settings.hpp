...
const double omega_max                 = 5E15;    /* maximum of plotted frequency Hz */
const double theta_max                 = 2.00;    /* maximum of theta in degree */
...
const unsigned int N_trace             = 0;       /* maximum number of traces */
...
const char traceFileTemplate[] = "./data/trace_%04d.txt";
...
const char outputFileTemplate[] = "./output/my_spectrum_trace%06d.dat";
